...
@section('content')
    <form class="row g-3 col-md-8" id="form-add_Product" action="{{ route('save.Product') }}" method="POST">
        ...
        <div class="col-md-12">
            ...
            <input type="text" class="form-control" placeholder="Digite nombre de producto" id="nombre" name="nombre"
        ...
        <div class="col-md-12">
            ...
            <input type="number" class="form-control" id="costo" name="costo" placeholder="Digite costo del producto"
